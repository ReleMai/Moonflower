...
public class Utils {
    ...
    public static final Config.Variable<String> prefspec = Config.Variable.prop("haven.prefspec", "hafen-MoonFlower");
	...
	if(prefs == null) {
		...
		if(prefs == null) {
			...
			if(base == null) {
			    ...
			    prefs = XmlPrefs.create(Utils.pj(base, "MoonFlower-prefs.xml"), node);
			}
		    }
		}
	    }
