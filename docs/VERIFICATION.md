...
| Private in-game HUD and combat-layout update | PASS (PACKAGE/PUBLISH) | The complete-window background fill, lower portrait clamp, persistent combat anchors, out-of-combat draggable ghosts, and floral combat deck compiled in the clean 921-source package. Identity, inventory lock, window placement, Cookbook, Fishing, Feasting, Combat Assist, Wiki, resource freshness, and MoonFlower HUD checks at 100/125/150/200% passed. The audited 734-file, 164,002,310-byte private stage used manifest SHA-256 `60e40ff3050c51e6e741662a8dde37dd75055e51e272d6858e5b6f11997a0f3c`; Steam logged `OK` and content manifest `6521566593530347140` for retained item `3788836144`. The subscribed and recreated no-login launcher-cache JARs matched staged SHA-256 `c88f38cde43c7c04f844c57545fd05d2bdc1be79ebeb5efb3745ad5bb8ec925c`. The prior item-specific cache remains in the reversible `.stale-pre-combat-hud-20260824-1655` backup; no login or world entry was attempted. |
| HUD cohesion and clipping pass | PASS (CLEAN BUILD/OFFLINE) | The shaped shared panel surface, single chat background owner, connected lower-right vine dock, themed menu-grid slots, and fluid illuminated portrait vitals compiled across all 921 sources in the guarded clean package with the same 11 existing warnings. `MoonFlowerHudChecks` passed at 100/125/150/200% UI scale and `InventorySlotLockChecks` passed. A live in-world visual comparison remains supervised and was not claimed from these offline checks. |
| Private HUD-cohesion and glow-only slot-lock release | PASS (PACKAGE/PUBLISH/CACHE) | The audited 734-file, 164,003,928-byte stage used manifest SHA-256 `6ee7b3b61bf511065f0dd73305686cd3d2ae0055051b0ff734ea40e2e0a9b6f6`. Steam logged upload result `OK` and content manifest `7315873725952964953` for retained private item `3788836144`. The subscribed and recreated no-login launcher-cache JARs match staged SHA-256 `5dc957cee55f0fcde399c319c6524a9da585cd3a7ff463e3527d15d4105fae75`; bytecode inspection confirms the locked-slot overlay contains only its glow fill and border. The prior item-specific cache remains recoverable in `.stale-pre-hud-cohesion-20260824-184119`, the verification client was stopped, and no login or world entry was attempted. |
