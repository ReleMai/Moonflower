...
public final class MoonFlowerUiAssets {
    ...
    private static final String INVENTORY_TOOLS_FRAME = "/haven/hud/moonflower-inventory-tools-frame-v1-alpha.png";
    ...
    private static final BufferedImage inventoryToolsFrameSource = trimTransparent(load(INVENTORY_TOOLS_FRAME), 4);
    ...
    public static final Tex inventoryToolsFrame = filtered(inventoryToolsFrameSource,
            Coord.of(UI.scale(260), UI.scale(320)));
    ...
    public static boolean complete() {
        if(windowFrame.length != 9 || panelTexture.sz().x <= 1 || chatSettings.sz().x <= 1 ||
                inventoryToolsFrame.sz().x <= 1 || inventoryToolsTab.sz().x <= 1 ||
                !hasTransparency(windowFrameSource) || !hasTransparency(chatSettingsSource) ||
                !hasTransparency(inventoryToolsFrameSource) || !hasTransparency(inventoryToolsTabSource))
            return false;
